...
function Alias() {
  return (
    <div>
        <section>
        <div className="container-fluid  alias">
        <img src="./Alias Logo 2.svg" alt="" />
          ...
          <div className="aliasbut mt-5">
              ...
              <a href="https://airtable.com/appT0poZ0DgKnUz4A/pagIVvmvDM2KN6Xb8/form" target="_blank">
                <button class="transparent-button">Get Started &nbsp; <i className="fa-solid fa-chevron-right"></i></button>
              </a>
          </div>  
          </div>
          </div>
