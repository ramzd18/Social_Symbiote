...
def generate_interviewdoc(agent,problem,product):
  listquestions=["Tell me about yourself. Be concise.","What are some interests/hobbies you have and what do you like doing. Be consice.","Desribe your personality. Be concise.",f"Do you think this problem: {problem} is a problem that you have. Be consice.", f"What are some pain points you might have with this problem: {problem}. Be consice.",f"Given this product:{product} can you think of any alternative comapnies and products you use. Desrcribe how you use these alternatives. Be consice.",f"What are your thoughts about this product: {product}. Is it something you would use reguarly? Do you think it would be useful for you. Be consice.",f"What are your biggest concerns about this product{product}. WHy might you not buy it? What worries you? What do you think could be a potential issue for you? Be consice.",f"Score the following product: {product} on how well it does in the fields of usabillity, value proposition and likelihood to recommend. Score each from 0 to 1 and return the scores in a list. For example you might return [.43,.51,.88]. Only put the numbers in the list. Return only the list and nothing else."]
  counter=0; 
  contextdoc=""
  interviewdoc=""
  interviewlist=[]
